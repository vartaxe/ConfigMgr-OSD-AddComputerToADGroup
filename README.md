...
**Live ConfigMgr and Active Directory testing was not executed for this release.** Use the [validation checklist](docs/validation.md) to verify your environment. Windows Server 2012/2012 R2 remains best effort with WMF 5.1, not a verified platform.
