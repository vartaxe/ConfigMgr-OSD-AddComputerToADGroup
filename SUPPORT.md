...
For v1.0.0, automated checks cover the source and mocked behavior. Live ConfigMgr and Active Directory testing was not executed; complete the [environment-validation checklist](docs/validation.md#required-live-tests) before broad rollout.
...
For vulnerabilities, use [private reporting](https://github.com/vartaxe/ConfigMgr-OSD-AddComputerToADGroup/security/advisories/new) instead of posting a public issue. If it is unavailable, contact [vartaxe@outlook.com](mailto:vartaxe@outlook.com) to arrange a private exchange; see [security](SECURITY.md). Maintainer: [Claudio Mendes (@vartaxe)](https://github.com/vartaxe).
