...
Describe 'Pages and release presentation contract' {
    ...
    It 'keeps the current version, two-stage regular-release target, and reciprocal links' {
        ...
        foreach ($Name in 'README.md', 'index.md') {
            ...
            $Content | Should -Match '(?i)regular (GitHub )?release'
            $Content | Should -Match '(?i)prerelease candidate'
            $Content | Should -Match '(?i)maintainer approval'
